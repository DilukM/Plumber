...
class BrowseJobRequests extends StatefulWidget {
  const BrowseJobRequests({super.key});

  @override
  State<BrowseJobRequests> createState() => _BrowseJobRequestsState();
}

class _BrowseJobRequestsState extends State<BrowseJobRequests> {
