...
class JobRequestPost extends StatefulWidget {
  const JobRequestPost({super.key});

  @override
  State<JobRequestPost> createState() => _JobRequestPostState();
}

class _JobRequestPostState extends State<JobRequestPost> {
