...
class EditBulkAdScreen extends StatefulWidget {
  final DocumentSnapshot adData;

  EditBulkAdScreen({required this.adData});

  @override
  _EditBulkAdScreenState createState() => _EditBulkAdScreenState();
}

class _EditBulkAdScreenState extends State<EditBulkAdScreen> {
