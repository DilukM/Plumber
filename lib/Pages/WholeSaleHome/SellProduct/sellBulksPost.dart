...
class SellBulkPost extends StatefulWidget {
  const SellBulkPost({super.key});

  @override
  State<SellBulkPost> createState() => _SellBulkPostState();
}

class _SellBulkPostState extends State<SellBulkPost> {
  ...
  final CollectionReference categoriesCollection =
      FirebaseFirestore.instance.collection('bulkCategories');
  ...
  Future<void> uploadResume() async {
    ...
    final resumeRef = storageRef.child(
        'BulkCovers/${DateTime.now().millisecondsSinceEpoch}_${coverFile!.path.split('/').last}');
  ...
  void submitJobPost() async {
    ...
    try {
      ...
      await products.add({
        ...
        'units': unitCountController.text,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Advertistment submitted successfully')),
      );
      ...
      unitCountController.clear();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to submit advertiestment: $e')),
      );
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                title: "Min units per bulk",
                label: "Enter unit count here",
                controller: unitCountController,
              ),
              CustomTextField(
                title: "Price",
                label: "Enter unit price here",
