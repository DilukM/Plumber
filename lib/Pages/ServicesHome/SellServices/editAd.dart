...
class EditServiceAdScreen extends StatefulWidget {
  final DocumentSnapshot adData;

  EditServiceAdScreen({required this.adData});

  @override
  _EditServiceAdScreenState createState() => _EditServiceAdScreenState();
}

class _EditServiceAdScreenState extends State<EditServiceAdScreen> {
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          label: const Text("Enter your description here"),
                        ),
                      ),
                    ],
                  ),
